...
```{r vital-records, echo=FALSE, fig.align='center', out.width='50%'}
knitr::include_graphics(
  "https://i.pinimg.com/564x/41/3b/c6/413bc64ac5be4f9c0fcce274a0ef341c.jpg")
```
]
...
```{r job-title-map, echo=FALSE, warning=FALSE, out.width='90%', fig.align='middle'}
...
```{r ma-leaflet-map, echo=FALSE, warning=FALSE, out.width='100%', fig.align='middle'}
...
ma_map <- leaflet(data = ma_geo) %>% 
  ...
  setView(lat = 42.2626, lng = -71.8023, zoom = 8)
...
---
```{r worcester-map, echo=FALSE, warning=FALSE, out.width='100%', fig.align='middle'}
...
---
```{r genealogy-map, echo=FALSE, warning=FALSE, out.width='100%', fig.align='center'}
...
- Professional sewing was a young women's field.
]
