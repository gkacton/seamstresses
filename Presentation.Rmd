...
## Job Title Popularity By Year --> relocate slide
...
```{r ma-leaflet-map, echo=FALSE, warning=FALSE, out.width='60%', fig.align='middle'}
...
```{r worcester-map, echo=FALSE, warning=FALSE, out.width='60%', fig.align='middle'}
...
```{r genealogy-map, echo=FALSE, warning=FALSE, out.width='60%', fig.align='left'}
